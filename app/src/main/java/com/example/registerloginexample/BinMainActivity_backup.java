...
//
//
//public class BinMainActivity_backup extends AppCompatActivity {
//
...
//                Intent intent = new Intent(BinMainActivity_backup.this, MainActivity.class);
...
//            @Override
//            public void onClick(View view) {
//                Intent intent = new Intent(BinMainActivity_backup.this, BinEditActivity.class);
//                intent.putExtra("userID",userID);
//                intent.putExtra("userName",userName);
//                intent.putExtra("address",address);
...
//            @Override
//            public void onClick(View view) {
//                Intent intent = new Intent(BinMainActivity_backup.this, ListActivity.class);
//
//                intent.putExtra("kind",kind);
//                intent.putExtra("binName",binName);
//                intent.putExtra("binLoc",binLoc);
...
//
//                                Intent intent = new Intent(BinMainActivity_backup.this, SellActivity.class);
//                                intent.putExtra("kind",kind);
//                                intent.putExtra("binName",binName);
//                                intent.putExtra("binLoc",binLoc);
//                                intent.putExtra("userID",userID);
...
//                RequestQueue queue = Volley.newRequestQueue(BinMainActivity_backup.this);
...
//            @Override
//            public void onClick(View view) {
//                Intent intent = new Intent(BinMainActivity_backup.this, SalesListActivity.class);
//                intent.putExtra("kind",kind);
//                intent.putExtra("binName",binName);
//                intent.putExtra("binLoc",binLoc);
//                intent.putExtra("userID",userID);
...
//
//        AlertDialog.Builder builder = new AlertDialog.Builder(BinMainActivity_backup.this);
...
//            @Override
//            public void onClick(View view) {
//                Intent intent = new Intent(BinMainActivity_backup.this,AddDropBinActivity.class);
//                intent.putExtra("kind",kind);
//                intent.putExtra("userID",userID);
//                intent.putExtra("userName",userName);
//                intent.putExtra("address",address);
...
//
//        SimpleAdapter simpleAdapter = new SimpleAdapter(BinMainActivity_backup.this, dialogItemList,
...
//                                String metal_full = jsonObject.getString("metal_full");
//
//                                Intent intent = new Intent(BinMainActivity_backup.this, BinMainActivity_backup.class);
//                                intent.putExtra("kind",kind);
//                                intent.putExtra("binName",binName);
//                                intent.putExtra("binLoc",binLoc);
//                                intent.putExtra("mDate",mDate);
